...
from genetic_algorithm import GenaticAlgorithm
...
class minimalESN:
    ...
    def __init__(self):
        ...
        errorLen = 500
        self.mse = sum( np.square( data[trainLen+1:trainLen+errorLen+1] - 
            Y[0,0:errorLen] ) ) / errorLen
        
        print('MSE = ' + str( self.mse ))

        self.M = self.GA.MSE(self.mse)    
        # plot some signals
        plt.figure(1).clear()
